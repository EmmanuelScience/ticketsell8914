...
insert into Events(eventName, venue, city, country, date, category)
    VALUE ('1', 'Venue', 'Madrid', 'Spain', '2022-12-31 23:59:59', 'musical');
insert into Events(eventName, venue, city, country, date, category)
    VALUE ('2', 'Venue', 'Madrid', 'Spain', '2022-12-31 23:59:59', 'musical');
insert into Events(eventName, venue, city, country, date, category)
    VALUE ('3', 'Venue', 'Madrid', 'Spain', '2022-12-31 23:59:59', 'musical');
insert into Events(eventName, venue, city, country, date, category)
    VALUE ('4', 'Venue', 'Madrid', 'Spain', '2022-12-31 23:59:59', 'musical');